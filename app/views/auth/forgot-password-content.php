    ...
    <div class="col-lg-5 col-md-7">
        <div class="card shadow-lg border-0" style="border-radius: 15px; overflow: hidden;">
            <div class="card-header text-white text-center py-4" style="background: linear-gradient(135deg, #148f77 0%, #16a085 100%); border: none;">
                <h2 class="mb-0" style="font-weight: 700; font-size: 28px;">🔐 Recuperar Contraseña</h2>
                <p class="mb-0" style="opacity: 0.9; font-size: 14px;">Te enviaremos instrucciones para recuperarla</p>
            </div>
        ...
        <div class="text-center mt-4" style="color: #999; font-size: 13px;">
            <p>✉️ Revisa tu bandeja de entrada para el enlace de recuperación</p>
        </div>
    </div>
</div>
