            ...
            <div class="card border-0 shadow-sm" style="background: linear-gradient(135deg, #148f77 0%, #16a085 100%); border-radius: 15px;">
                <div class="card-body text-center py-5 text-white">
                    <h1 style="font-weight: 700; font-size: 36px; margin-bottom: 10px;">
                        <i class="fas fa-fish"></i> Mis Acuarios
                    </h1>
                    <p style="font-size: 18px; opacity: 0.9; margin-bottom: 20px;">Gestiona y organiza tus ecosistemas acuáticos</p>
                    <a href="<?php echo APP_URL; ?>/aquarium/create" class="btn btn-light btn-lg" style="padding: 12px 35px; border-radius: 50px; font-weight: 600; box-shadow: 0 4px 15px rgba(0,0,0,0.2);">
                        <i class="fas fa-plus-circle"></i> Crear Nuevo Acuario
                    </a>
                </div>
            </div>
        </div>
            ...
            <div class="col-12">
                <div class="card border-0 shadow-sm" style="border-radius: 15px;">
                    <div class="card-body text-center py-5">
                        ...
                        <h3 style="color: #666; margin-bottom: 15px;">Aún no tienes acuarios</h3>
                        <p style="color: #999; font-size: 16px; margin-bottom: 30px;">
                            Comienza tu aventura acuática creando tu primer acuario
                        </p>
                        <a href="<?php echo APP_URL; ?>/aquarium/create" class="btn btn-primary btn-lg">
                            <i class="fas fa-plus-circle"></i> Crear Mi Primer Acuario
                        </a>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card-body" style="padding: 20px;">
                            ...
                            <div class="row g-2 mb-3">
                                <div class="col-6">
                                    <div style="background: #f8f9fa; padding: 12px; border-radius: 10px; text-align: center;">
                                        ...
                                        <div style="font-size: 11px; color: #7f8c8d; text-transform: uppercase;">Volumen</div>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div style="background: #f8f9fa; padding: 12px; border-radius: 10px; text-align: center;">
                                        ...
                                        <div style="font-size: 11px; color: #7f8c8d; text-transform: uppercase;">Tipo</div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div style="border-top: 1px solid #ecf0f1; padding-top: 15px; margin-top: 15px;">
                                <small style="color: #95a5a6; display: flex; align-items: center; gap: 5px;">
                                    ...
                                    Creado el <?php echo date('d/m/Y', strtotime($aquarium['created_at'])); ?>
                                </small>
                            </div>
                    ...
                    <div class="card-body text-center py-4">
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <div style="color: #7f8c8d; font-size: 14px;">Total de Acuarios</div>
                            </div>
                            <div class="col-md-4">
                                <div style="font-size: 32px; font-weight: 700; color: #16a085;">
                                    <?php echo count(array_filter($aquariums, fn($a) => $a['status'] == 'activo')); ?>
                                </div>
                                <div style="color: #7f8c8d; font-size: 14px;">Activos</div>
                            </div>
                            <div class="col-md-4">
                                <div style="font-size: 32px; font-weight: 700; color: #16a085;">
                                    <?php echo array_sum(array_column($aquariums, 'volume_liters')); ?>L
                                </div>
                                <div style="color: #7f8c8d; font-size: 14px;">Volumen Total</div>
                            </div>
                        </div>
                    </div>
                </div>
