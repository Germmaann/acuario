<div class="container-fluid">
            ...
            <div class="card border-0 shadow-sm" style="background: linear-gradient(135deg, #d35400 0%, #e67e22 100%); border-radius: 15px;">
                <div class="card-body py-5 text-white text-center">
                    <h1 style="font-weight: 700; font-size: 36px; margin-bottom: 10px;">
                        <i class="fas fa-chart-line"></i> Dashboard de Terrarios
                    </h1>
                    <p style="font-size: 16px; opacity: 0.9; margin-bottom: 0;">Resumen y estadísticas de tus terrarios</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row mb-4" data-aos="fade-up">
        <div class="col-lg-3 col-md-6 mb-3">
            <div class="card border-0 shadow-sm" style="border-radius: 12px; border-top: 4px solid #e67e22;">
                <div class="card-body text-center py-4">
                    <i class="fas fa-leaf" style="font-size: 32px; color: #e67e22; margin-bottom: 10px; display: block;"></i>
                    <h3 style="font-size: 32px; font-weight: 700; color: #2c3e50; margin: 0;">
                        <?php echo $statistics['total_terrariums'] ?? 0; ?>
                    </h3>
                    <p style="color: #7f8c8d; margin: 8px 0 0 0; font-size: 14px;">Total de Terrarios</p>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-3 col-md-6 mb-3">
            <div class="card border-0 shadow-sm" style="border-radius: 12px; border-top: 4px solid #27ae60;">
                <div class="card-body text-center py-4">
                    ...
                    <h3 style="font-size: 32px; font-weight: 700; color: #2c3e50; margin: 0;">
                        <?php echo $statistics['active_terrariums'] ?? 0; ?>
                    </h3>
        ...
        <div class="col-lg-3 col-md-6 mb-3">
            <div class="card border-0 shadow-sm" style="border-radius: 12px; border-top: 4px solid #9b59b6;">
                <div class="card-body text-center py-4">
                    <i class="fas fa-thermometer-half" style="font-size: 32px; color: #9b59b6; margin-bottom: 10px; display: block;"></i>
                    <h3 style="font-size: 24px; font-weight: 700; color: #2c3e50; margin: 0;">
                        <?php echo round($statistics['avg_temp_min'] ?? 0, 1); ?>°C - <?php echo round($statistics['avg_temp_max'] ?? 0, 1); ?>°C
                    </h3>
                    <p style="color: #7f8c8d; margin: 8px 0 0 0; font-size: 14px;">Temp. Promedio</p>
                </div>
            </div>
        </div>
    </div>
                            ...
                            <div style="display: flex; justify-content: space-between; align-items: start;">
                                <div>
                                    ...
                                    <small style="color: #95a5a6;">
                                        Realizado: <?php echo date('d/m/Y', strtotime($alert['created_at'])); ?>
                                    </small>
                                </div>
                                <span style="background: <?php echo $alert['days_remaining'] < 0 ? '#e74c3c' : '#f39c12'; ?>; color: white; padding: 8px 15px; border-radius: 20px; font-weight: 600; font-size: 12px;">
                                    <?php 
                                        if ($alert['days_remaining'] < 0) {
                                            echo 'Vencido ' . abs($alert['days_remaining']) . 'd';
                                        } else {
                                            echo 'En ' . $alert['days_remaining'] . 'd';
                                        }
                                    ?>
                                </span>
                            </div>
                        ...
                        <?php foreach ($recentMaintenance as $maint): ?>
                            <div style="padding-bottom: 15px; border-bottom: 1px solid #ecf0f1; margin-bottom: 15px;">
                                ...
                                <p style="margin: 5px 0; color: #7f8c8d; font-size: 13px;">
                                    <strong><?php echo htmlspecialchars($maint['terrarium_name']); ?></strong>
                                </p>
                                <small style="color: #95a5a6;">
            ...
            <div class="card border-0 shadow-sm" style="border-radius: 12px;">
                ...
                <div class="card-body">
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 12px;">
                        <a href="<?php echo APP_URL; ?>/terrarium/create" class="btn btn-primary" style="border-radius: 8px; padding: 15px; text-align: center; text-decoration: none; background: linear-gradient(135deg, #d35400 0%, #e67e22 100%); color: white; font-weight: 600;">
                            <i class="fas fa-plus-circle"></i><br>
                            <small>Crear Terrario</small>
                        </a>
                        <a href="<?php echo APP_URL; ?>/terrarium/gallery" class="btn btn-info" style="border-radius: 8px; padding: 15px; text-align: center; text-decoration: none; background: #3498db; color: white; font-weight: 600;">
                            <i class="fas fa-images"></i><br>
                            <small>Ver Galería</small>
                        </a>
                        <a href="<?php echo APP_URL; ?>/terrarium/search" class="btn btn-warning" style="border-radius: 8px; padding: 15px; text-align: center; text-decoration: none; background: #f39c12; color: white; font-weight: 600;">
                            <i class="fas fa-search"></i><br>
                            <small>Buscar</small>
                        </a>
                        <a href="<?php echo APP_URL; ?>/terrarium" class="btn btn-success" style="border-radius: 8px; padding: 15px; text-align: center; text-decoration: none; background: #27ae60; color: white; font-weight: 600;">
                            <i class="fas fa-list"></i><br>
                            <small>Mis Terrarios</small>
                        </a>
                    </div>
                </div>
            </div>
    ...
    <div class="row" data-aos="fade-up">
        <div class="col-12">
            <div class="card border-0 shadow-sm" style="border-radius: 12px;">
                <div class="card-body">
                    <h5 style="font-weight: 700; color: #2c3e50; margin-bottom: 20px;">
                        <i class="fas fa-water"></i> Parámetros Promedio
                    </h5>
                    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 20px;">
                        <div>
                            <label style="font-size: 12px; color: #7f8c8d; text-transform: uppercase; font-weight: 600;">Humedad Promedio</label>
                            <div style="margin-top: 10px;">
                                <div style="background: #ecf0f1; border-radius: 10px; overflow: hidden; height: 30px;">
                                    <div style="background: linear-gradient(90deg, #3498db 0%, #2980b9 100%); width: <?php echo min(100, round($statistics['avg_humidity'] ?? 0)); ?>%; height: 100%; display: flex; align-items: center; justify-content: center; color: white; font-weight: 700; font-size: 12px;">
                                        <?php echo round($statistics['avg_humidity'] ?? 0); ?>%
                                    </div>
                                </div>
                            </div>
                        </div>
